...
import theSpeedster.vfx.general.CalmFireEffect;
import theSpeedster.vfx.general.CasualFlameParticleEffect;

import java.util.ArrayList;

public class SpeedsterEnergyOrb extends CustomEnergyOrb {
    public static final String[] orbTextures = {
            TheSpeedster.makeCharPath("orb/layerFake.png"),
            TheSpeedster.makeCharPath("orb/layerFake.png"),
            TheSpeedster.makeCharPath("orb/layerFake.png"),
            TheSpeedster.makeCharPath("orb/layerFake.png"),
            TheSpeedster.makeCharPath("orb/layerFake.png"),
    ...
    private static final String VFXTexture = TheSpeedster.makeCharPath("orb/EnergyRecharge.png");
